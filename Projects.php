...
<div class="columns" style="overflow-y: hidden;">
  ...
  <div class="control">
    <div class="tags has-addons">
      ...
      <div class="card-content">
        <div class="content">
          An RPG text based game created in ruby; a continuous work in progress.
          <br>
        </div>
      </div>
      <footer class="card-footer">
...
An annoying piece of malware, that roots itself within the registry with random keys and runs on startup with TTS popups that can only be removed by killing the processes individually.
  ...
  <div class="control">
    <div class="tags has-addons">
      ...
      <div class="card-content">
        <div class="content">
    An Apache Cordova stop watch application ready to be used as a module in other applications or built into a standalone app. All UI are modulare and can be reused as suited for your projects.
          <br>
        </div>
      </div>
      <footer class="card-footer">
